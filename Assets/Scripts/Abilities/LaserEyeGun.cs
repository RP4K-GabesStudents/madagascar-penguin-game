...
namespace Abilities
{
    public class LaserEyeGun : BaseWeaponGun
    {
        ...
        public override void Execute()
        {
            ...
            Instantiate(laser, _oner.laserSpawn.position, Quaternion.LookRotation(leftLaserDir, Vector3.up)).Init(gameObject);
            Instantiate(laser, _oner.laserSpawn2.position, Quaternion.LookRotation(rightLaserDir, Vector3.up)).Init(gameObject);
        }
    }
}